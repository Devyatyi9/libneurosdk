...
Usage:
    python tests/run_tests.py                   # localhost:9001, skip server start on Win/macOS
    python tests/run_tests.py 192.168.1.10      # remote host:9001
    python tests/run_tests.py 192.168.1.10 9002 # remote host:9002
