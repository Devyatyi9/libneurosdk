...
int main(void) {
    ...
    {
        const unsigned char mask[4] = {0x0F, 0xF0, 0x5A, 0xA5};
        const unsigned char data[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07};
    ...
    /* Masking: len 0 and len not multiple of 4 */
    {
        ...
        const unsigned char data[] = {0x10, 0x20, 0x30, 0x40, 0x50, 0x60};
        unsigned char masked_buf[sizeof(data)];
