...
int main(void) {
	...
	test("empty", (unsigned char const *)"", 0, "");
	test("f", (unsigned char const *)"f", 1, "Zg==");
	test("fo", (unsigned char const *)"fo", 2, "Zm8=");
	test("foo", (unsigned char const *)"foo", 3, "Zm9v");
	test("foob", (unsigned char const *)"foob", 4, "Zm9vYg==");
	test("fooba", (unsigned char const *)"fooba", 5, "Zm9vYmE=");
	test("foobar", (unsigned char const *)"foobar", 6, "Zm9vYmFy");
